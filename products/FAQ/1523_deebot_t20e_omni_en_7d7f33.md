...
Open the app, go to Smart Cleaning ＞ Map Management, and tap saved maps to set settings. 
1. Quick mapping, map naming, map deletion, map backup and restore 
...
2: Virtual Wall: Tap the saved map and select map edit to set up virtual wall related settings 
...
3. Area Type: Map Management ＞ Saved Maps ＞ Area Type 
4. Area Division: Map Management ＞ Saved Maps ＞ Area Division 
5. Area Merging: Map Management ＞ Saved Maps ＞ Area Merging
