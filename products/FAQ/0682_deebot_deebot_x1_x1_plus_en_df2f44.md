...
(2) Do not move the robot frequently while it is cleaning. If you need to change the cleaning pad, return the robot to its original location before starting it again. The robot will try to reposition itself and continue cleaning. 
