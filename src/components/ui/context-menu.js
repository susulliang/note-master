...
function ContextMenuItem({ className, inset, variant = "default", disabled, onClick, onMouseDown, onKeyDown, onKeyUp, onPointerDown, ...props }) {
...
function ContextMenuCheckboxItem({ className, children, checked, disabled, onClick, onMouseDown, onKeyDown, onKeyUp, onPointerDown, ...props }) {
...
function ContextMenuRadioItem({ className, children, disabled, onClick, onMouseDown, onKeyDown, onKeyUp, onPointerDown, ...props }) {
